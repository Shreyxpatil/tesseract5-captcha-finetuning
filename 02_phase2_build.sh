...
TRAIN_DIR="$SCRIPT_DIR/training_data_phase2"
...
all_file = pathlib.Path("/home/ca/Projects/captcha_model/model_output_phase2/all_lstmf.txt")
...
out = pathlib.Path("/home/ca/Projects/captcha_model/model_output_phase2")
